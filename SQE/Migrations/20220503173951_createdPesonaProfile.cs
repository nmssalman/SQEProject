...
{
    public partial class createdPesonaProfile : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    Image_Base64_String = table.Column<string>(type: "text", nullable: true),
                    ActiveStatus = table.Column<bool>(type: "tinyint(1)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserProfilePictures_PersonalDetails_PersonalDetailsId",
                        column: x => x.PersonalDetailsId,
                        principalTable: "PersonalDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonalDetails_UserProfilePictureId",
                table: "PersonalDetails",
                column: "UserProfilePictureId");

            migrationBuilder.CreateIndex(
                name: "IX_UserProfilePictures_PersonalDetailsId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PersonalDetails_UserProfilePictures_UserProfilePictureId",
                table: "PersonalDetails",
                column: "UserProfilePictureId",
